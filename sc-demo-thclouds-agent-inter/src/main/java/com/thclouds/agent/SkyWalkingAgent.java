...
import com.thclouds.agent.plugin2.*;
...
import com.thclouds.agent.plugin2.bootstrap.BootstrapInstrumentBoost;
import com.thclouds.agent.plugin2.jdk9module.JDK9ModuleExporter;
    ...
    public static void premain(String agentArgs, Instrumentation instrumentation) throws PluginException {
        ...
        try {
            ...
            LogManager.getLogger(SkyWalkingAgent.class)
                    .error(e, "thclouds agent initialized failure. Shutting down.");
            return;
        } finally {
