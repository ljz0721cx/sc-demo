...
public class ConfigInitializer {
        ...
        for (Field field : recentConfigType.getFields()) {
            if (Modifier.isPublic(field.getModifiers()) && Modifier.isStatic(field.getModifiers())) {
                ...
                if (type.equals(Map.class)) {
                    ...
                    final org.apache.skywalking.apm.util.Length lengthDefine = field.getAnnotation(org.apache.skywalking.apm.util.Length.class);
    ...
    private static List<String> convert2List(String value) {
        if (org.apache.skywalking.apm.util.StringUtil.isEmpty(value)) {
        ...
        for (String segment : segments) {
            ...
            if (org.apache.skywalking.apm.util.StringUtil.isNotEmpty(trimmedSegment)) {
...
class ConfigDesc {
    ...
    void append(String currentDesc) {
        if (org.apache.skywalking.apm.util.StringUtil.isNotEmpty(currentDesc)) {
