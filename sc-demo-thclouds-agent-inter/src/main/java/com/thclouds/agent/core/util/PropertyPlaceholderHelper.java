...
public enum PropertyPlaceholderHelper {
    ...
    INSTANCE(
        org.apache.skywalking.apm.util.PlaceholderConfigurerSupport.DEFAULT_PLACEHOLDER_PREFIX,
        org.apache.skywalking.apm.util.PlaceholderConfigurerSupport.DEFAULT_PLACEHOLDER_SUFFIX, org.apache.skywalking.apm.util.PlaceholderConfigurerSupport.DEFAULT_VALUE_SEPARATOR,
        true
    );
    ...
    PropertyPlaceholderHelper(String placeholderPrefix, String placeholderSuffix, String valueSeparator,
        ...
        if (org.apache.skywalking.apm.util.StringUtil.isEmpty(placeholderPrefix) || org.apache.skywalking.apm.util.StringUtil.isEmpty(placeholderSuffix)) {
    ...
    private int findPlaceholderEndIndex(CharSequence buf, int startIndex) {
        ...
        while (index < buf.length()) {
            if (org.apache.skywalking.apm.util.StringUtil.substringMatch(buf, index, this.placeholderSuffix)) {
            ...
            } else if (org.apache.skywalking.apm.util.StringUtil.substringMatch(buf, index, this.simplePrefix)) {
                withinNestedPlaceholder++;
